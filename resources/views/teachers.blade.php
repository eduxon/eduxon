...
<!-- Mirrored from www.radiustheme.com/demo/html/psdboss/akkhor/akkhor/index5.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 06 Aug 2019 06:32:45 GMT -->
                                        ...
                                        <table class="table display data-table text-nowrap">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="text-center"><img src="{{asset('eduxon/img/figure/student2.png')}}" alt="student"></td>
                                                    <td>Mark Willy</td>
                                                    <td>Male</td>
                                                    <td>2</td>
                                                    <td>A</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center"><img src="{{asset('eduxon/img/figure/student3.png')}}" alt="student"></td>
                                                    <td>Jessia Rose</td>
                                                    <td>Female</td>
                                                    <td>1</td>
                                                    <td>A</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center"><img src="{{asset('eduxon/img/figure/student4.png')}}" alt="student"></td>
                                                    <td>Mark Willy</td>
                                                    <td>Male</td>
                                                    <td>2</td>
                                                    <td>A</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center"><img src="{{asset('eduxon/img/figure/student5.png')}}" alt="student"></td>
                                                    <td>Jessia Rose</td>
                                                    <td>Female</td>
                                                    <td>1</td>
                                                    <td>A</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center"><img src="{{asset('eduxon/img/figure/student6.png')}}" alt="student"></td>
                                                    <td>Mark Willy</td>
                                                    <td>Male</td>
                                                    <td>2</td>
                                                    <td>A</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center"><img src="{{asset('eduxon/img/figure/student7.png')}}" alt="student"></td>
                                                    <td>Jessia Rose</td>
                                                    <td>Female</td>
                                                    <td>1</td>
                                                    <td>A</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center"><img src="{{asset('eduxon/img/figure/student8.png')}}" alt="student"></td>
                                                    <td>Mark Willy</td>
                                                    <td>Male</td>
                                                    <td>2</td>
                                                    <td>A</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center"><img src="{{asset('eduxon/img/figure/student9.png')}}" alt="student"></td>
                                                    <td>Jessia Rose</td>
                                                    <td>Female</td>
                                                    <td>1</td>
                                                    <td>A</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center"><img src="{{asset('eduxon/img/figure/student10.png')}}" alt="student"></td>
                                                    <td>Mark Willy</td>
                                                    <td>Male</td>
                                                    <td>2</td>
                                                    <td>A</td>
...
<!-- Mirrored from www.radiustheme.com/demo/html/psdboss/akkhor/akkhor/index5.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 06 Aug 2019 06:32:48 GMT -->
</html>